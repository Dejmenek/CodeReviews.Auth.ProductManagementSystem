...
public abstract class UpdateProductViewModel
{
    [Required]
...
public abstract class UpdateComputerViewModel : UpdateProductViewModel
{
...
public class UpdateLaptopViewModel : UpdateComputerViewModel
{
    [Required]
...
public class UpdateDesktopViewModel : UpdateComputerViewModel
{
    [Required]
