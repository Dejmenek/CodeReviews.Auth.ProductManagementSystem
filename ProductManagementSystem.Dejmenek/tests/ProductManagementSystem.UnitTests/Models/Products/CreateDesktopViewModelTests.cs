...
public class CreateDesktopViewModelTests
{
    private IList<ValidationResult> ValidateModel(CreateDesktopViewModel model)
    {
    ...
    private CreateDesktopViewModel GetValidModel()
    {
        return new CreateDesktopViewModel
        {
            Name = "Desktop X",
            Price = 1299.99m,
            IsActive = true,
