...
public class UpdateLaptopViewModelTests
{
    private IList<ValidationResult> ValidateModel(UpdateLaptopViewModel model)
    {
    ...
    private UpdateLaptopViewModel GetValidModel()
    {
        return new UpdateLaptopViewModel
        {
            Name = "Laptop X",
            Price = 999.99m,
            IsActive = true,
